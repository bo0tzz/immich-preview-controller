defmodule PreviewControllerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PreviewControllerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PreviewControllerWeb.Gettext, "errors", msg, opts)
    # end
